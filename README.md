...
> Dos Políticos serão armazenados o nome, nível de mandato, cargo político, ano do mandato, fim do mandatado, estado de atuação, descrição. Dos Partidos serão armazenados o número, nome, fundadores, aprovação na cláusula de barreira, ano de criação, princípios, resumo sobre a história. Da Comissão serão armazenados o nome e o período. Das Propostas legislativas serão armazenados tipo, resumo e se foi aprovada ou não. Os políticos podem dirigir trabalhos legislativos. Eles moderam um ou mais políticos e são moderados por um ou mais. O político também pode participar de um partido ou ser independente, já o partido precisa ter um ou pode ser composto por vários políticos. A comissão é composta por no mínimo um político ou vários, porém o político tem a restrição de participar de apenas uma comissão. Uma possibilidade de atuação do político é a interação com nenhuma ou várias propostas legislativas, que pode ser criando, votando ou assinando alguma. Após criada por um político, ela pode ser associada por vários e será discutida por exclusivamente uma comissão. A mesma comissão pode discutir diversas propostas diferentes. No sistema, o cliente irá realizar um cadastro. Do cliente precisamos armazenar o nome, e-mail, senha e estado de preferência, para acompanhar as atualizações referentes. O cliente poderá acompanhar nenhuma ou várias propostas legislativas, assim como as propostas podem ser seguidas por nenhum ou vários clientes.<br> 

### 4.PROTOTIPAÇÃO, PERGUNTAS A SEREM RESPONDIDAS E TABELA DE DADOS<br>
#### 4.1 RASCUNHOS BÁSICOS DA INTERFACE (MOCKUPS)<br>
![Alt text](https://github.com/higorcamposs/FeedPolitico/blob/master/arquivos/feedpolitico_v2.pdf "Feed Politico")
![Arquivo PDF do Protótipo Balsamiq feito para desenvolvimento do sistema de Feed Politico](https://github.com/higorcamposs/FeedPolitico/blob/master/arquivos/feedpolitico_v2.pdf?raw=true "Feed Politico")
